...
This is a simple, console-based Student Grade Management System implemented in Java.
Here many Features are available 
1. Add Student: with Student Id, Student Name and Marks
...
4. Calculate Average: Automatically compute Average marks of all students
-------------------------------------------------------------------------------------
  ### How to Run the Program
01. Install java in your computer
02. Download this command
03. open your command prompt
04. Compile the java file using following command
